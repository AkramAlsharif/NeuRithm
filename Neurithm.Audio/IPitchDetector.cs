...
public sealed class PitchDetectorOptions
{
    ...
    public double MinRmsForDetection { get; set; } = 0.005;
    public double MinConfidence { get; set; } = 0.40;
    public int MinStableDetections { get; set; } = 1;
    public int DebounceMilliseconds { get; set; } = 70;
    ...
    public double MinCorrelationPeak { get; set; } = 0.20;
    public int SmoothingWindowMilliseconds { get; set; } = 160;
    public int FrameIntervalMilliseconds { get; set; } = 25;
    public int MinSamplesForAveraging { get; set; } = 3;
    public double DominantNoteVoteThreshold { get; set; } = 0.50;
}
